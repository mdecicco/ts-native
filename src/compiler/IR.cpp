...
namespace tsn {
    namespace compiler {
        constexpr ir_instruction_info opcode_info[] = {
            ...
            { "noop"          , 0, { ot_nil, ot_nil, ot_nil }, 0xFF, 0, 0, 0, 0 },
            { "label"         , 1, { ot_lbl, ot_nil, ot_nil }, 0xFF, 0, 0, 0, 0 },
            { "stack_allocate", 2, { ot_imm, ot_imm, ot_nil }, 0xFF, 0, 0, 0, 0 },
            { "stack_ptr"     , 2, { ot_reg, ot_imm, ot_nil }, 0   , 0, 0, 0, 0 },
            { "stack_free"    , 1, { ot_imm, ot_nil, ot_nil }, 0xFF, 0, 0, 0, 0 },
            { "module_data"   , 3, { ot_reg, ot_imm, ot_imm }, 0   , 0, 0, 0, 0 },
            { "reserve"       , 1, { ot_reg, ot_nil, ot_nil }, 0   , 0, 0, 0, 0 },
            { "resolve"       , 2, { ot_reg, ot_val, ot_nil }, 0xFF, 0, 0, 0, 0 },
            { "load"          , 3, { ot_reg, ot_reg, ot_imm }, 0   , 0, 0, 0, 0 },
            { "store"         , 3, { ot_val, ot_reg, ot_imm }, 0xFF, 0, 0, 0, 0 },
            { "jump"          , 1, { ot_lbl, ot_nil, ot_nil }, 0xFF, 0, 0, 0, 0 },
            { "cvt"           , 3, { ot_reg, ot_val, ot_imm }, 0   , 0, 0, 0, 0 },
            { "param"         , 2, { ot_val, ot_imm, ot_nil }, 0xFF, 0, 0, 0, 0 },
            { "call"          , 1, { ot_fun, ot_nil, ot_nil }, 0xFF, 1, 0, 0, 0 },
            { "ret"           , 0, { ot_nil, ot_nil, ot_nil }, 0xFF, 0, 0, 0, 0 },
            { "branch"        , 3, { ot_reg, ot_lbl, ot_lbl }, 0xFF, 0, 0, 0, 0 },
            { "vset"          , 2, { ot_reg, ot_reg, ot_nil }, 0xFF, 0, 1, 0, 0 },
            { "vadd"          , 2, { ot_reg, ot_reg, ot_nil }, 0xFF, 0, 1, 0, 0 },
            { "vsub"          , 2, { ot_reg, ot_reg, ot_nil }, 0xFF, 0, 1, 0, 0 },
            { "vmul"          , 2, { ot_reg, ot_reg, ot_nil }, 0xFF, 0, 1, 0, 0 },
            { "vdiv"          , 2, { ot_reg, ot_reg, ot_nil }, 0xFF, 0, 1, 0, 0 },
            { "vmod"          , 2, { ot_reg, ot_reg, ot_nil }, 0xFF, 0, 1, 0, 0 },
            { "vneg"          , 1, { ot_reg, ot_nil, ot_nil }, 0xFF, 0, 1, 0, 0 },
            { "vdot"          , 3, { ot_reg, ot_reg, ot_reg }, 0   , 0, 0, 0, 0 },
            { "vmag"          , 2, { ot_reg, ot_reg, ot_nil }, 0   , 0, 0, 0, 0 },
            { "vmagsq"        , 2, { ot_reg, ot_reg, ot_nil }, 0   , 0, 0, 0, 0 },
            { "vnorm"         , 1, { ot_reg, ot_nil, ot_nil }, 0xFF, 0, 1, 0, 0 },
            { "vcross"        , 3, { ot_reg, ot_reg, ot_reg }, 0xFF, 0, 1, 0, 0 },
            { "iadd"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "uadd"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "fadd"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "dadd"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "isub"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "usub"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "fsub"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "dsub"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "imul"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "umul"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "fmul"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "dmul"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "idiv"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "udiv"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "fdiv"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "ddiv"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "imod"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "umod"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "fmod"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "dmod"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "ilt"           , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "ult"           , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "flt"           , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "dlt"           , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "ilte"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "ulte"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "flte"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "dlte"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "igt"           , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "ugt"           , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "fgt"           , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "dgt"           , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "igte"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "ugte"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "fgte"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "dgte"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "ieq"           , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "ueq"           , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "feq"           , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "deq"           , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "ineq"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "uneq"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "fneq"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "dneq"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "iinc"          , 1, { ot_reg, ot_nil, ot_nil }, 0   , 0, 0, 0, 0 },
            { "uinc"          , 1, { ot_reg, ot_nil, ot_nil }, 0   , 0, 0, 0, 0 },
            { "finc"          , 1, { ot_reg, ot_nil, ot_nil }, 0   , 0, 0, 0, 0 },
            { "dinc"          , 1, { ot_reg, ot_nil, ot_nil }, 0   , 0, 0, 0, 0 },
            { "idec"          , 1, { ot_reg, ot_nil, ot_nil }, 0   , 0, 0, 0, 0 },
            { "udec"          , 1, { ot_reg, ot_nil, ot_nil }, 0   , 0, 0, 0, 0 },
            { "fdec"          , 1, { ot_reg, ot_nil, ot_nil }, 0   , 0, 0, 0, 0 },
            { "ddec"          , 1, { ot_reg, ot_nil, ot_nil }, 0   , 0, 0, 0, 0 },
            { "ineg"          , 2, { ot_reg, ot_val, ot_nil }, 0   , 0, 0, 0, 0 },
            { "fneg"          , 2, { ot_reg, ot_val, ot_nil }, 0   , 0, 0, 0, 0 },
            { "dneg"          , 2, { ot_reg, ot_val, ot_nil }, 0   , 0, 0, 0, 0 },
            { "not"           , 2, { ot_reg, ot_val, ot_nil }, 0   , 0, 0, 0, 0 },
            { "inv"           , 2, { ot_reg, ot_val, ot_nil }, 0   , 0, 0, 0, 0 },
            { "shl"           , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "shr"           , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "land"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "band"          , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "lor"           , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "bor"           , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "xor"           , 3, { ot_reg, ot_val, ot_val }, 0   , 0, 0, 0, 0 },
            { "assign"        , 2, { ot_reg, ot_val, ot_nil }, 0   , 0, 0, 0, 0 }
        };
