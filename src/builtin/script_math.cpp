...
namespace gjs {
    namespace math {
        ...
        void bind_vec2(script_module* mod, const char* name) {
            ...
            v.method("operator /=", METHOD_PTR(vec2<T>, operator /=, vec2<T>, const vec2<T>&));
            v.method("operator /=", METHOD_PTR(vec2<T>, operator /=, vec2<T>, T));
            v.method("length", &vec2<T>::mag);
            v.method("lengthSq", &vec2<T>::magSq);
            v.method("fromAngleLength", &vec2<T>::fromAngleMag);
            v.method("fromAngleLengthr", &vec2<T>::fromAngleMag_r);
            v.prop("x", &vec2<T>::x, bind::property_flags::pf_none);
            v.prop("y", &vec2<T>::y, bind::property_flags::pf_none);
        ...
        void bind_math(script_context* ctx) {
            ...
            // functions
            {
                ...
                m->bind<f64>(random, "random");
                m->bind<f32>(random, "random");
                m->bind<i64>(random, "random");
                m->bind<u64>(random, "random");
                m->bind<i32>(random, "random");
                m->bind<u32>(random, "random");
                m->bind<i16>(random, "random");
                m->bind<u16>(random, "random");
                m->bind<i8>(random, "random");
                m->bind<u8>(random, "random");
