...
Just download [This Archive](https://download1349.mediafire.com/zogwr5fiqgng/kicmp6mui2ka5dg/gjs.llvm.vs2019.rar) and extract the `llvm` folder to `gjs/deps` once you clone the repo.
