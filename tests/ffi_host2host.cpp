...
TEST_CASE("FFI", "[host to host arguments]") {
    utils::Mem::Create();
    {
        ...
        DataType* i32_tp = ctx.getTypes()->getInt32();
        ...
        SECTION("Callee is a global function") {
            SECTION("Callee has signature void (*)(i32, i32, i32)") {
                ...
                SECTION("Caller passes (Object&, Object&, Object&)") {
                    ...
                    Object oa = Object::View(&ctx, false, i32_tp, &a1);
                    Object ob = Object::View(&ctx, false, i32_tp, &b1);
                    Object oc = Object::View(&ctx, false, i32_tp, &c1);
        ...
        SECTION("Callee is a class method") {
            _h2h_test _test;
            Object test = Object::View(&ctx, false, test_tp, &_test);
        ...
        SECTION("Callee is a primitive pseudo-method") {
            i32 _test;
            Object test = Object::View(&ctx, false, i32_tp, &_test);
