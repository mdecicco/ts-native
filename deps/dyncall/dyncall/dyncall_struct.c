...
void dcStructField(DCstruct* s, DCint type, DCint alignment, DCint offset, DCsize arrayLength)
{
	DCfield *f;
...
{
	// disabled due to new parameter on dcStructField and my lack of a need for this function
	return 0;
	/*
	DCstruct* s;
